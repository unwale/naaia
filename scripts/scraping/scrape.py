...
import pandas as pd
import logging
from scrapers import NewsSource, NewsItem, Platform
...
data: pd.DataFrame = pd.DataFrame(columns=['date', 'title', 'summary', 'text', 'source_name', 'source_id', 'source_platform', 'news_url', 'tags'])
