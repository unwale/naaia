...
class NewsSource:
    ...
    Attributes:
        ...
        platform : Platform
        id : str
            Identificator which the source can be distinguished
            by within the same platform
...
class Parser(ABC):
    ...
    async def fetch_news(self, item_limit: int) -> List[NewsItem]:
        ...
        Returns:
            List of NewsItem objects, each having source set
            as the source provided to the parser
        """
        pass
