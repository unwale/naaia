...
topic_examples = test_data[['text', 'topic']].sample(15).apply(lambda x: (x['text'], x['topic']), axis=1).tolist() 

model = YandexFewShot(folder_id='b1g2v1k5v5v5v5v5v5', api_key='b1g2v1k5v5v5v5v5v5', examples=topic_examples)
