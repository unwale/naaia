...
python -m scripts.training.topic_classification.bert_lin_text --model ai-forever/ruBert-large --tokenizer_max_length 512
...
python -m scripts.training.topic_classification.bert_mlp_text --model ai-forever/ruBert-large --tokenizer_max_length 512
