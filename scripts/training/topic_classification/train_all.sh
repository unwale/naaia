...
python -m scripts.training.topic_classification.bert_lin_text --model DeepPavlov/rubert-base-cased --model_max_length 512
...
python -m scripts.training.topic_classification.bert_mlp_text --model DeepPavlov/rubert-base-cased --model_max_length 512
...
python -m scripts.training.topic_classification.bert_multifeature.py --model DeepPavlov/rubert-base-cased --model_max_length 512
