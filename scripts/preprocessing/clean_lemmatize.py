...
parser = argparse.ArgumentParser(description='Clean and lemmatize text in a jsonl file')
parser.add_argument('--input', type=str, help='Path to input jsonl file', default='.../data/raw/data.jsonl')
parser.add_argument('--target-field', type=str, help='Name of the field to clean and lemmatize', default='text')
parser.add_argument('--output', type=str, help='Path to save the output', default='.../data/processed/data_cleaned.jsonl')
