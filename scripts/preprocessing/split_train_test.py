...
parser = argparse.ArgumentParser(
    description="Split a jsonl file into train and test sets"
)
parser.add_argument(
    "--input",
    type=str,
...
parser.add_argument(
    ...
    default=".../data/raw/test.jsonl",
)
parser.add_argument(
    "--n", type=int, help="Number of samples to take", default=10000
)
parser.add_argument(
    "--ratio", type=float, help="Train-test split ratio", default=0.9
)
